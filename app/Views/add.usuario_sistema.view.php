                ...
                <form action="/usuarios-sistema/add" method="post">         
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-sm-12">
                            ...
                            <select name="id_rol" id="rol" class="form-control select2" data-placeholder="Rol">
                                <option value="">-</option>
                        ...
                        <div class="mb-3 col-sm-12">
                            ...
                            <select name="id_idioma" id="id_idioma" class="form-control select2" data-placeholder="Idioma">
                                <option value="">-</option>
