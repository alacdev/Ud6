    ...
    <body class="hold-transition sidebar-mini layout-fixed <?php echo isset($_COOKIE['dark']) ? 'dark-mode' : ''; ?>">
        <div class="wrapper"> 
          ...
          <i class="text fas fa-moon"></i>
                        ...
                        ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo isset($_SESSION['user']['id_usuario']) ? '/session/borrar' : '/login'; ?>" role="button">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <a href="<?php echo isset($_SESSION['user']['id_usuario']) ? '/profile/' . $_SESSION['user']['id_usuario'] : '/login'; ?>"
                               class="d-block"> <?php echo isset($_SESSION['user']['nombre']) ? $_SESSION['user']['nombre'] : '<i>Sin establecer</i>'; ?> </a>    
                        </div>
                    </div>
